...
# 默认填充示例SKU
#default_skus = "\n".join(["10121090", "10329250", "10329298", "10129032", "10328020", "10329116"])
#batch_sku_text.insert(tk.END, default_skus)
#batch_sku_text.focus()
...
# 默认填充示例前端SKU
#default_frontend_skus = "\n".join(["10121090", "10329250", "10329298", "10129032"])
#batch_frontend_sku_text.insert(tk.END, default_frontend_skus)
